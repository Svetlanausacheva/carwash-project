...
class UrlTest(TestCase):
    ...
    def test_create_booking_url(self):
        ...
        self.assertEqual(resolver.func.__name__, booking_views.BookingCreateView.__name__)
    ...
    def test_customer_profile_url(self):
        ...
        self.assertEqual(resolver.func.__name__, customer_views.CustomerProfileView.__name__)
    ...
    def test_edit_profile_url(self):
        ...
        self.assertEqual(resolver.func.__name__, customer_views.CustomerUpdateView.__name__)
    ...
    def test_registration_url(self):
        ...
        self.assertEqual(resolver.func.__name__, booking_views.UserRegistrationView.__name__)