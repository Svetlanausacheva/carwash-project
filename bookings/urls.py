...
urlpatterns = [
    ...
    path('bookings/<int:pk>/edit/', views.BookingUpdateView.as_view(), name='edit_booking'),
    path('bookings/<int:pk>/delete/', views.BookingDeleteView.as_view(), name='delete_booking'),
]